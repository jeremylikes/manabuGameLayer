...
{
    public class WaterKeyReceptacle : PuzzleCondition, IInteractable
    {
        [SerializeField] private Sprite _solvedSpite;
        ...
        public void Interact()
        {
            if (!_conditionIsMet)
            {
                ...
                if (!manabu._itemInventory.ItemContainedInInventory(_dependentItem))
                {
                    ...
                    var filePath = $"{FileManagement.MessagesUIDirectory}/System/exitToWaterheartHint";
                ...
                if (itemFromInventory != null)
                {
                    ...
                    if (_solvedSpite != null)
                        GetComponent<SpriteRenderer>().sprite = _solvedSpite;
                }
            }
        }
    }
